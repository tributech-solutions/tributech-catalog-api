...
export interface Interface { 
    ...
    context: InterfaceContextEnum;
    contents?: Array<Property | Relationship | Component | Command> | null;
    _extends?: string | Array<string> | null;
    schemas?: Array<InterfaceSchema> | null;
}
export enum InterfaceTypeEnum {
    Interface = 'Interface'
};
export enum InterfaceContextEnum {
